    ...
    <div class="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <aside class="w-64 bg-[#1e3a8a] dark:bg-gray-800 text-white flex flex-col">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1">
          ...
          <a routerLink="/settings" routerLinkActive="bg-orange-500" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-blue-800 transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <main class="flex-1 overflow-auto">
        ...
        <header class="bg-white border-b px-8 py-4 flex items-center justify-between">
          ...
          <div class="flex items-center space-x-4">
            <button class="p-2 hover:bg-gray-100 rounded-lg" (click)="toggleDarkMode()">
              <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"/>
              </svg>
            </button>
            <span class="text-sm text-gray-600">Welcome, <strong>{{ authService.user()?.email?.split('@')[0] || 'User' }}</strong></span>
          </div>
        </header>
          ...
          <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
              ...
              <form [formGroup]="profileForm" class="space-y-4">
                ...
                <div>
                  <label class="text-sm font-semibold text-gray-700 mb-1 block">Phone Number</label>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
              ...
              <form [formGroup]="currencyForm" class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label class="text-sm font-semibold text-gray-700 mb-1 block">Home Currency</label>
              ...
              <div class="space-y-3">
                @for (pref of notificationPreferences; track pref.id) {
                  <label class="flex items-center justify-between py-2 cursor-pointer">
                    <div>
                      <p class="font-medium text-gray-800 dark:text-white">{{ pref.label }}</p>
              ...
              <div class="space-y-4">
                <div>
                  <button type="button" 
                    ...
                    <div>
                      <p class="font-medium text-gray-800 dark:text-white">Change Password</p>
                ...
                <div>
                  <button type="button"
                          class="w-full text-left px-4 py-3 border rounded-lg hover:bg-gray-50 flex items-center justify-between">
                    <div>
                      <p class="font-medium text-gray-800 dark:text-white">Two-Factor Authentication</p>
                      <p class="text-sm text-gray-500">Add an extra layer of security</p>
                    </div>
                    <span class="px-2 py-1 bg-green-100 text-green-700 text-xs font-semibold rounded">Enabled</span>
                  </button>
                </div>
                <div>
                  <button type="button"
                          class="w-full text-left px-4 py-3 border rounded-lg hover:bg-gray-50 flex items-center justify-between">
                    <div>
                      <p class="font-medium text-gray-800 dark:text-white">Active Sessions</p>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border-2 border-red-200">
              ...
              <div class="space-y-3">
                <button type="button"
                        class="w-full text-left px-4 py-3 border border-red-300 rounded-lg hover:bg-red-50 flex items-center justify-between">
                  <div>
                    <p class="font-medium text-red-600">Export All Data</p>
                    <p class="text-sm text-gray-500">Download all your transaction data</p>
                  </div>
