    ...
    <div class="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <aside class="w-64 bg-[#1e3a8a] dark:bg-gray-800 text-white flex flex-col">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1">
          ...
          <a routerLink="/alerts" routerLinkActive="bg-orange-500" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-blue-800 transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <main class="flex-1 overflow-auto">
        ...
        <header class="bg-white border-b px-8 py-4 flex items-center justify-between">
          <div>
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Alerts & Notifications</h2>
          </div>
        ...
        <div class="p-8">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
            ...
            <div class="grid grid-cols-2 gap-6">
              <div class="space-y-4">
                <h4 class="text-sm font-semibold text-gray-700">Email Notifications</h4>
              ...
              <div class="space-y-4">
                <h4 class="text-sm font-semibold text-gray-700">Push Notifications</h4>
