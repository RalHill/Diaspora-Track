    ...
    <div class="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <aside class="w-64 bg-[#1e3a8a] dark:bg-gray-800 text-white flex flex-col">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1">
          ...
          <a routerLink="/expenses" routerLinkActive="bg-orange-500" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-blue-800 transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <main class="flex-1 overflow-auto">
        ...
        <div class="p-8">
          <div class="mb-6 flex items-center justify-between">
            <div>
              <h3 class="text-xl font-bold text-gray-800 dark:text-white">Track Your Expenses</h3>
              <p class="text-gray-600 dark:text-gray-400">Monitor spending across all categories</p>
            </div>
            <button routerLink="/add-transaction" 
                    class="bg-orange-500 text-white px-6 py-3 rounded-lg hover:bg-orange-600 font-semibold flex items-center space-x-2">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
