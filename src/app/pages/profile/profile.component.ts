    ...
    <div class="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main class="flex-1 overflow-auto lg:ml-0 pt-14 lg:pt-0">
        ...
        <header class="bg-white dark:bg-gray-800 border-b dark:border-gray-700 px-4 lg:px-8 py-4 flex items-center justify-between">
          <div>
            <h2 class="text-xl lg:text-2xl font-bold text-gray-800 dark:text-white">Profile</h2>
          </div>
        ...
        <div class="p-4 lg:p-8">
          <div class="max-w-3xl mx-auto space-y-4">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 lg:p-6">
              ...
              <p class="text-gray-600 dark:text-gray-400">{{ authService.user()?.email }}</p>
            </div>

            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 lg:p-6">
              <h3 class="font-semibold mb-2 text-gray-900 dark:text-white">Preferred Currency</h3>
              <p class="text-gray-600 dark:text-gray-400">CAD - Canadian Dollar</p>
            </div>

            <button (click)="authService.signOut()"
                    class="w-full bg-red-600 text-white py-3 rounded-xl font-semibold hover:bg-red-700 min-h-[44px]">
              Sign Out
            </button>
          </div>
        </div>
